-- Add unique constraint on user_id for subscribers table
ALTER TABLE public.subscribers ADD CONSTRAINT subscribers_user_id_unique UNIQUE (user_id);

-- Fix the admin_override_subscription function to handle conflicts properly
...
BEGIN
  ...
  DO UPDATE SET 
    ...
    account_type = new_account_type::account_type,
